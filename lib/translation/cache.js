 ...
 * Used by the service worker for `TRANSLATE_NO_CACHE` (e.g. callers that must bypass cache).
 * Full-sentence lines in the content script use `translateWithCache` like word glosses.
 * @param {object} settings
 * @param {string[]} texts
 * @param {string} sourceLang
 * @param {string} targetLang
